...
function interpreter(ast, filePathOrOptions) {
    ...
    let lastReplValue = undefined;
    let hasReplValue = false;
    if (isOptions && filePathOrOptions.isRepl) {
        const originalOnReplResult = filePathOrOptions.onReplResult;
        filePathOrOptions.onReplResult = (val, formatted) => {
            lastReplValue = val;
            hasReplValue = true;
            if (originalOnReplResult) originalOnReplResult(val, formatted);
        };
    }
